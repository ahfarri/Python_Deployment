...
class Recipe:
    ...
    def made_date(self):
        return self.made.strftime("%m-%d-%Y")

    @classmethod
    def create_recipe(cls, data):
        query = "INSERT INTO recipes ( name , description, minutes, instructions, made_on, users_id, created_at, updated_at ) VALUES ( %(name)s , %(description)s, %(minutes)s, %(instructions)s, %(made_on)s, %(users_id)s, NOW() , NOW() );"
